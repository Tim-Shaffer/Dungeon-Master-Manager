...
function Jumbo() {
  ...
  return (
    <div>
        <div className="row">  
        <div className="col">
            <div className="jumbotron min-vh-100 text-center m-0 bg-info d-flex flex-column justify-content-center" id="jumbo" 
                // style={{ BackGroundImage: `linear-gradient(to bottom, rgba(255,255,255,0.6) 0%,rgba(255,255,255,0.9) 100%), 
                // url(https://i0.wp.com/nerdsonearth.com/wp-content/uploads/2019/12/dndmobile-br-1559158957902.jpg?fit=1280%2C720&ssl=1)` }}
                >
